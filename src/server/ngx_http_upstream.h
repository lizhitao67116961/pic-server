...
typedef ngx_int_t (*ngx_http_upstream_init_pt)(ngx_http_upstream_srv_conf_t *us);
...
typedef struct {
	...
	intptr_t buffering;
	intptr_t pass_request_headers;
	intptr_t pass_request_body;

	intptr_t ignore_client_abort;
	intptr_t intercept_errors;
	intptr_t cyclic_temp_file;
...
ngx_int_t ngx_http_upstream_header_variable(ngx_http_request_t *r, uintptr_t data);

ngx_int_t ngx_http_upstream_create(ngx_http_request_t *r);
ngx_int_t ngx_http_upstream_init(ngx_pool_t *pool);
void ngx_http_upstream_init_request(ngx_http_request_t *r);
char *ngx_http_upstream_bind_set_slot(ngx_command_t *cmd, void *conf);
ngx_int_t ngx_http_upstream_hide_headers_hash(ngx_http_upstream_conf_t *conf, ngx_http_upstream_conf_t *prev, ngx_str_t *default_hide_headers, ngx_hash_init_t *hash);
